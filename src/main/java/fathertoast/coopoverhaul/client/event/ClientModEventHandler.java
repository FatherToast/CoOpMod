...
import fathertoast.coopoverhaul.client.coordination.PartyStatusGuiOverlay;
...
public final class ClientModEventHandler {
    ...
    static void onClientSetup( FMLClientSetupEvent event ) {
        ...
        ClientConfigUtil.registerConfigButtonAsEditScreen( CoOpOverhaulMod.INSTANCE.CONTAINER );
    }
