...
public final class ClientWork {
    ...
    @OnClient
    public static void handleMainConfigSync( ClientboundMainConfigSyncPacket message ) { ClientConfig.sync( message ); }
    ...
    @OnClient
    public static void handlePing( ClientboundEntityPingPacket message ) { ClientPingHelper.receivePing( message ); }
    
    @OnClient
    public static void handlePing( ClientboundBlockPingPacket message ) { ClientPingHelper.receivePing( message ); }
    
    @OnClient
    public static void handleFindPlayersData( ClientboundFindPlayersDataPacket message ) {
        FindPlayersManager.updatePlayerPositions( message );
    }
